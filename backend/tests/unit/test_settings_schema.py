...
EXPECTED_KEYS: list[tuple[str, str, str, object, bool]] = [
    ...
    ("mqtt.topic_readings", "string", "mqtt", "oiltank/level", False),
    ...
    ("prices.homefuelsdirect_url", "string", "prices",
     "https://homefuelsdirect.co.uk/home/heating-oil-prices/dorset", False),
    ...
    ("schedule.analysis_cron", "cron", "schedule", "0 2 * * 0", False),
    ("schedule.cost_analysis_cron", "cron", "schedule", "0 3 1 * *", False),
